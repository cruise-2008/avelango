...
(function () {
    ...
    angular
        .module('app.tables')
        .controller('DataTableControllerUserss', dataTableControllerUserss);

    dataTableControllerUserss.$inject = ['$resource', 'DTOptionsBuilder', 'DTColumnDefBuilder', 'sweetAlert', '$uibModal', '$scope', 'urlSvc'];//,'DatatableUsers'
    function dataTableControllerUserss($resource, DTOptionsBuilder, DTColumnDefBuilder, sweetAlert, $uibModal, $scope, urlSvc) {
        var vm = this;
