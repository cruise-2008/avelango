...
(function () {
    ...
    angular
        .module('app.tables')
        .controller('DataTableControllerMoney', dataTableControllerMoney);

    dataTableControllerMoney.$inject = ['$resource', 'DTOptionsBuilder', 'DTColumnDefBuilder', 'sweetAlert', '$uibModal', '$scope', 'urlSvc'];//,'DatatableUsers'
    function dataTableControllerMoney($resource, DTOptionsBuilder, DTColumnDefBuilder, sweetAlert, $uibModal, $scope, urlSvc) {
        var vm = this;
        ...
        function activate() {
            ...
            // Ajax
            var url = urlSvc.GetMyCardsTransactions;
